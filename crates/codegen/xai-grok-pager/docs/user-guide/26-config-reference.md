...
| `ui.copy_markdown_shortcut` | `string` | `yes` | `user` | Chord that copies an assistant message's markdown source. Unset keeps Ctrl+Shift+Y and F6. `off` unbinds. Examples: `alt+y`, `f6`. |
